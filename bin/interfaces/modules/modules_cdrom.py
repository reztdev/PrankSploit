...
from bin.modules.payloads.cdrom import CD_ROM_Payloads
import bin.interfaces.MainConsole
from bin.interfaces.source.help_interfaces.modules.help_cdrom import (
    showHelpMessage, showOptionsMessage
)

filename = ''
class Payloads_CDROM(object):

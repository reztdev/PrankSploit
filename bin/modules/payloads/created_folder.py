...
from bin.modules.encode.encode import CreateFolder
from src.Logging.print_stdout import print_error, print_process

class Created_Folder_Flooder(object):
    def __init__(self, output_file):
        self.code = CreateFolder
    ...
    def writing_payload(self):
        try:
            print_process("Loaded payload CreatedFolder_Flooder...")

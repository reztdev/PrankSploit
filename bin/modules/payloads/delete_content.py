...
from bin.modules.encode.encode import DeleteAllContent
from src.Logging.print_stdout import print_error, print_process

class Delete_Content(object):
    def __init__(self, output_file):
        self.code = DeleteAllContent
    ...
    def writing_payload(self):
        try:
            print_process("Loaded payload Delete_Content...")
